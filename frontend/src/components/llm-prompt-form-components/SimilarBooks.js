    ...
    return (
        <div className='similar-books'>
            ...
            <div className='similar-books-box'>
                <textarea rows={4} cols={62} placeholder='Please seperate book titles with commas.' className='similar-books-input' name={name} value={value} onChange={onChange}></textarea>
            </div>
        </div>
    );
}
